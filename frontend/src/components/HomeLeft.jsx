        ...
        <div className='min-w-[350px] w-1/5 h-screen flex flex-col justify-between border border-red-500 select-none'>
            <div className=" h-full border border-gray-500 p-4">
                ...
                <div className="h-[75vh] overflow-y-scroll scrollbar pr-2">
                    ...
                    {/* important caetgory */}
                    <div className={`flex items-center mb-4 pl-2 border border-gray-500 p-2 rounded-md cursor-pointer bg-[#536fcd] text-white capitalize`} onClick={() => { handleSelected('important') }} >

                    <img src={WhiteHamburger} alt="" className='w-6 h-5 mr-3'/>
                    ...
                    </div>
                    {
                        categories?.map((category, index) => (
                            ...
                            <div className={`flex items-center mb-4 pl-2 border border-gray-500 p-2 rounded-md cursor-pointer ${selected?._id == category?._id ? "bg-gray-500 text-white" : ""} capitalize`} onClick={() => { handleSelected(category) }} key={index}>
                                ...
                                <img src={ selected?._id === category?._id ? WhiteHamburger: Hamburger} alt="" className='w-6 h-5 mr-3'/>
